...
extern "C" __global__ __aicore__ void ada_block_sparse_attention_FIAS(__gm__ uint8_t* query, __gm__ uint8_t* key,
                                                            ...
                                                            __gm__ uint8_t* workspace, __gm__ uint8_t* tiling)
{
    ...
    TILING_KEY_IS(1000000000002011112);
        ...
        INVOKE_BSA_GENERAL_OP_IMPL(AdaBlockSparseAttentionS1s2Bns1X910, BSAType<BSALayout::BSH, bfloat16_t,
            bool, bfloat16_t>);
    #elif TILING_KEY_VAR == 1000000000000011112 || TILING_KEY_VAR == 1000000000002011112
        // BNSD layout bf16 cvdiff
        INVOKE_BSA_GENERAL_OP_IMPL(AdaBlockSparseAttentionS1s2Bns1X910, BSAType<BSALayout::BNSD, bfloat16_t,
            bool, bfloat16_t>);
    #endif
...
extern "C" __global__ __aicore__ void ada_block_sparse_attention(__gm__ uint8_t* query, __gm__ uint8_t* key,
                                                             __gm__ uint8_t* value, __gm__ uint8_t* pseShift,
