...
protected:
    ge::graphStatus ConvertContextToBSAParams(gert::TilingContext* context, ContextParamsForBSATiling& contextKeyParams,
        AdaBlockSparseAttentionTilingData& tilingData);
    ge::graphStatus TilingGetTilingKeyAttentionAscendC(
        uint64_t& tilingKey, ContextParamsForBSATiling& contextKeyParams,
    ...
    void AdaBlockSparseAttentionInitSoftmaxLseOutputSplit(
        uint64_t totalSize, AdaBlockSparseAttentionTilingData &tilingData);
